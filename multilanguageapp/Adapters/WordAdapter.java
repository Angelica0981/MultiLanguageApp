...
public class WordAdapter extends ArrayAdapter<Word> {
    ...
    private final int iColorResourceId;
    ...
    // check the existing view group is being reused, other wise inflate the view
        ...
        //find the text view in the list_item.xml layout with the id indonesian
        TextView miwokTextView = ListItemView.findViewById(R.id.indonesian_text_view);

        //get the version from the current word object and set this text in miwok translation
        miwokTextView.setText(currentWord.getiIndonesianTranslation());
